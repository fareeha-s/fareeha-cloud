                      ...
                      <p className="text-white/65 font-normal px-1 text-sharp overflow-hidden" style={{ 
                        ...
                        {widgets[currentWidgetIndex].type === 'notes'
                          ? (widgetNote.title.includes("hello world")
                              ? "my north star: designing tech that centres human longevity. I'm on the launch team for Sanscritic, a new technology for agent builders. I also built Kineship, a social layer for workouts. In Autumn 2026, I'll be producing a fashion show..."
